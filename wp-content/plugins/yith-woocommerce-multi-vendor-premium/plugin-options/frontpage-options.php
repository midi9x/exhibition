...
return array(
    ...
    'frontpage' => array(
        ...
        'frontpage_vendors_registration_vat' => array(
            ...
            'title' => sprintf( "%s %s", $vat_ssn_label, _x('number', 'part of: VAT/SSN number', 'yith-woocommerce-product-vendors') ),
            'type' => 'checkbox',
        ...
        'frontpage_header_image_size_width' => array(
            ...
            'type'   => 'number',
            'desc'   => __('Change the default image height for header. Set width to zero to use original image width (Default: 0 px).', 'yith-woocommerce-product-vendors'),
        ...
        'frontpage_related_products' => array(
            ...
            'options' => array(
                'disable' => __('Do not show related products', 'yith-woocommerce-product-vendors'),
