...
class YITH_WC_Email_Commissions_Paid extends WC_Email {
	...
	function __construct() {
		...
		$this->title 			= __( 'Commission paid (for Admin)', 'yith-woocommerce-product-vendors' );
		$this->description		= __( 'New commissions are credited to vendor', 'yith-woocommerce-product-vendors' );

		$this->heading 			= __( 'Commission paid', 'yith-woocommerce-product-vendors' );
