...
if ( !function_exists( 'yith_wcmv_create_capabilities' ) ) {
    ...
    function yith_wcmv_create_capabilities( $capability_type ) {
        ...
        $capabilities = array(
            ...
            "edit_cf7submits" => true,
            "edit_others_cf7submits" => true,
            "publish_cf7submits" => true,
            "read_private_cf7submits" => true,
            "edit_private_cf7submits" => true,
            "edit_published_cf7submits" => true,
        );
