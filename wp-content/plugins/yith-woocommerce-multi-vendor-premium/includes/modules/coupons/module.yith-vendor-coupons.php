...
if ( ! class_exists( 'YITH_Vendor_Coupons' ) ) {
    ...
    class YITH_Vendor_Coupons extends YITH_Abstract_Vendor_Coupons {
        ...
        public function extra_construct_action(){
            ...
            add_filter( 'yith_wc_multi_vendor_coupon_types', 'YITH_Vendor_Coupons::allowed_coupon_types' );
        }
         ...
         * @return array
         */
        public static function allowed_coupon_types( $allowed ){
            $allowed = array( 'fixed_cart' );
            return $allowed;
        }
         ...
         * @return void
         */
        public static function prevent_vendor_created_cart_percent_coupon(){
            ...
            if( $vendor->is_valid() && $vendor->has_limited_access() ){
                ...
                if( $is_shop_coupon && $is_percent_shop_coupon && empty( $_POST['product_ids'] ) ){
                    ...
                    $vendor_product_ids = implode( ',', $vendor->get_products( array( 'exclude' => $to_exclude ) ) );

                    update_post_meta( $_POST['ID'], 'product_ids', $vendor_product_ids );
                }
            }
        }
