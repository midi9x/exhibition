...
<div class="<?php echo $store_header_class . ' ' . $header_skin  ?>">
    <!--  Header Image -->
    ...
    <div class="store-info <?php echo $header_skin ?>">
        ...
        <div class="store-contact">
            ...
            <?php endif; ?>
            <?php if( ! empty( $vendor->website ) && $website['show'] ) : ?>
                <span class="store-website">
                    <i class="<?php echo $icons['website'] ?>"></i>
                    <?php printf( __( '<a href="%s" target="_blank">%s</a>', 'yith-woocommerce-product-vendors' ), $website['url'], $website['label'] ); ?>
                </span>
            <?php endif; ?>
