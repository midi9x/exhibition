...
echo sprintf( __( 'The order #%d from %s has been cancelled. The order was as follows:', 'woocommerce' ), $order_number, $billing_first_name . ' ' . $billing_last_name ) . "\n\n";
...
echo date_i18n( __( 'jS F Y', 'woocommerce' ), strtotime( $order_date ) ) . "\n";
