 ...
 */
$vat_ssn_string = get_option( 'yith_vat_label', __( 'VAT/SSN', 'yith-woocommerce-product-vendors' ) );
?>
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="<?php echo apply_filters( 'yith_wcmv_vendor_panel_form_action', admin_url( 'admin.php' ) ); ?>" enctype="multipart/form-data">
        <h3><?php _e( 'Vendor shop page information', 'yith-woocommerce-product-vendors' ) ?></h3>
        ...
        <div class="form-field contact-info">
            ...
            <label for="vendor_legal_notes"><?php _e( 'Company legal notes', 'yith-woocommerce-product-vendors' ) ?></label>
            ...
            <?php if( 'yes' == get_option( 'yith_wpv_vendor_show_vendor_website', 'no' ) ) : ?>
                <label for="vendor_website"><?php _e( 'Website url', 'yith-woocommerce-product-vendors' ) ?></label>
                <input id="vendor_website" type="text" name="yith_vendor_data[website]" value="<?php echo $vendor->website ?>" class="regular-text"  placeholder="http://" />
                <br />
                <span class="description"><?php _e( 'Insert website url', 'yith-woocommerce-product-vendors' ); ?></span>
            <?php endif; ?>
        </div>
