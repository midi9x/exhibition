...
<tr class="form-field">
    <th scope="row" valign="top">
        <label for="yith_vendor_website"><?php _e( 'Website', 'yith-woocommerce-product-vendors' ); ?></label>
    </th>
    <td>
        <input type="text" class="regular-text" name="yith_vendor_data[website]" id="yith_vendor_website" value="<?php echo $vendor->website ?>" placeholder="http://"/><br />
