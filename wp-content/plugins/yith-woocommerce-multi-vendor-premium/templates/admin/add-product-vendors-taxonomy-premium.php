...
<div class="form-field">
    <label for="yith_vendor_legal_notes">
        <?php _e( 'Company legal notes', 'yith-woocommerce-product-vendors' ); ?>
    </label>
...
<div class="form-field">
    <label for="yith_vendor_legal_notes">
        <?php _e( 'Website', 'yith-woocommerce-product-vendors' ); ?>
    </label>
    <input type="text" class="regular-text" name="yith_vendor_data[website]" id="yith_vendor_website" value="" placeholder="http://" /><br />
